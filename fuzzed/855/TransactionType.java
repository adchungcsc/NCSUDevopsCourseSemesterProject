...
public enum TransactionType {
     ...
     */
    PRESCRIPTION_EDIT ( 911, "NkeaYcl", true ),
    /**
     ...
     */
    VIEW_USER_LOG ( 1301, "FkyfMi", false ),
    /**
     ...
     * Create basic health metrics
     */
    OPHTHALMOLOGY_SURGERY_CREATE ( 2211, "Create ophthalmology surgery for patient", true ),
    /**
     * HCP views basic health metrics
     */
