...
public enum TransactionType {
     ...
     * Successful login
     */
    LOGIN_SUCCESS ( 2, "Successful login", false ),
    /**
     * User logged out
     */
     ...
     */
    VIEW_USERS ( 112, "KVkL", false ),
    /**
     * User deleted
     */
    DELETE_USER ( 103, "JtB", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 641, "General checkup requested by patient", true ),
    /**
     ...
     */
    DRUG_CREATE ( 911, "Admin created a new drug", false ),
    /**
     ...
     * Remove a user as a personal representative.
     */
    REMOVE_SELF_AS_PR ( 1614, "Fbzu", false ),
    /**
     * Admin creates new LOINC code.
     */
    LOINC_CREATE ( 1711, "zLtPNQ", false ),
    /**
     ...
     */
    PATIENT_DELETES_OPH_SURG ( 2013, "zvKfF", false ),
    /**
     ...
     */
    VIEW_BLOOD_SUGAR_LIMITS_HCP ( 2507, "dVRmSy", false ),
    /**
