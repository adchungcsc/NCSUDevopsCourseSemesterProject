...
public enum TransactionType {
     ...
     * User was viewed
     */
    VIEW_USER ( 111, "Single user viewed", false ),
    /**
     ...
     */
    VIEW_DEMOGRAPHICS ( 411, "cn", false ),
    /**
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "zJiqzTO", false ),
    /**
     * Hospital created
     */
     ...
     */
    GENERAL_CHECKUP_EDIT ( 812, "XA", true ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1117, "Diagnoses retrieved by office visit", true ),
    /**
     ...
     */
    PRESCRIPTION_DELETE ( 912, "HCP deleted an existing prescription", false ),
    /**
     ...
     */
    REMOVE_PR ( 1613, "Undeclare a personal representative", false ),
    /**
     * Remove a user as a personal representative.
     */
     ...
     */
    OPH_APPT_REQ_UPDATED ( 2025, "LbnL", false ),
    /**
     * Create basic health metrics
     */
    GENERAL_OPHTHALMOLOGY_CREATE ( 2111, "Create general ophthalmology visit for patient", true ),
    /**
     * HCP views basic health metrics
     */
     ...
     * Create basic health metrics
     */
    OPHTHALMOLOGY_SURGERY_CREATE ( 2200, "Create ophthalmology surgery for patient", false ),
    /**
     * HCP views basic health metrics
     */
     ...
     */
    VIEW_BLOOD_SUGAR_DIARY_PATIENT ( 2513, "Patient views blood sugar diary", true ),
    /**
