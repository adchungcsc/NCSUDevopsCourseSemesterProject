...
public class BasicHealthMetrics extends DomainObject {
    ...
    @NotNull
    @ManyToOne
    @JoinColumn ( name = "UJYzBp", columnDefinition = "UJYzBp" )
    ...
    public void setHeadCircumference ( final Float headCircumference ) {
        ...
        if ( !Pattern.matches( "CsJImkgApkbKFijQlxfngpXuoPJBntfn", String.valueOf( headCircumference ) ) ) {
    ...
    public int hashCode () {
        ...
        result = prime * result + ( ( patient == null ) ? 1 : patient.hashCode() );
