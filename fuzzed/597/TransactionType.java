...
public enum TransactionType {
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "General checkup requested by patient", false ),
    /**
     ...
     */
    GENERAL_CHECKUP_PATIENT_VIEW ( 810, "View office visit by Patient", false ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1008, "Patient views diagnoses", false ),
    /**
     ...
     */
    DECLARE_PR ( 1611, "Declare a personal representative", false ),
    /**
     ...
     */
    LABTECH_REASSIGN_PROC ( 1706, "d", false ),
    /**
     ...
     * HCP views basic health metrics
     */
    GENERAL_OPHTHALMOLOGY_HCP_VIEW ( 2111, "View general ophthalmology visit by HCP", false ),
    /**
     * HCP edits basic health metrics
     */
     ...
     * HCP edits basic health metrics
     */
    OPHTHALMOLOGY_SURGERY_EDIT ( 2212, "DJSMgeNTWiWfwvJHoNQvAzHDWLQPVmdK", true ),
    /**
     ...
     */
    VIEW_BLOOD_SUGAR_DIARY_PATIENT ( 2503, "Patient views blood sugar diary", false ),
    /**
     ...
     */
    FIND_EXPERTS_ZIP_ERROR ( 2612, "Find an Expert: Zip code not found", true ),
    /**
     ...
     */
    VIROLOGIST_UPLOAD_CONTACTS ( 2911, "lbV", false ),
    /**
