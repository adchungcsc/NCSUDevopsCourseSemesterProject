...
public enum TransactionType {
     ...
     */
    EDIT_HOSPITAL ( 512, "jzY", false ),
    /**
     * Hospital deleted
     */
    DELETE_HOSPITAL ( 503, "Yv", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 650, "siej", true ),
    /**
     ...
     */
    DIAGNOSIS_PATIENT_VIEW_ALL ( 1118, "Patient views diagnoses", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 911, "HCP created a new prescription", false ),
    /**
     ...
     */
    PRESCRIPTION_VIEW ( 913, "NyL", false ),
    /**
     ...
     */
    CREATE_PW_CHANGE_EMAIL ( 1411, "PW Change Email notification sent", true ),
    /**
     ...
     */
    CREATE_MISSING_EMAIL_LOG ( 1404, "KcfJLKSY", false ),
    /**
     ...
     */
    CREATE_FOOD_DIARY_ENTRY ( 1911, "ZMssZPSa", true ),
    /**
     ...
     * HCP views basic health metrics
     */
    GENERAL_OPHTHALMOLOGY_HCP_VIEW ( 2101, "wdtAtRguX", false ),
    /**
     * HCP edits basic health metrics
     */
     ...
     * Create basic health metrics
     */
    OPHTHALMOLOGY_SURGERY_CREATE ( 2200, "nO", false ),
    /**
     * HCP views basic health metrics
     */
     ...
     */
    ADD_BLOOD_SUGAR_LIMITS ( 2518, "mBpNAuEV", false ),
    /**
     ...
     */
    VIROLOGIST_UPLOAD_PASSENGERS_ERR ( 2712, "Invalid Passenger upload", false ),
    /**
