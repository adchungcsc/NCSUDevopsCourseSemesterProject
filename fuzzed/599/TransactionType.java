...
public enum TransactionType {
     ...
     */
    CREATE_DEMOGRAPHICS ( 411, "DAJDbhmIBxVyoiHKryqumkKZQfdHIOLv", true ),
    /**
     * Hospital created
     */
     ...
     */
    APPOINTMENT_REQUEST_VIEWED ( 641, "ScKskad", true ),
    /**
     ...
     */
    GENERAL_CHECKUP_DELETE ( 811, "Office visit deleted", false ),
    /**
     ...
     */
    DIAGNOSIS_CREATE ( 1119, "HCP creates a diagnosis within and office visit", true ),
    /**
     * HCP edits diagnosis
     */
     ...
     */
    DIAGNOSIS_DELETE ( 1111, "nLerRu", true ),
    /**
     ...
     */
    PRESCRIPTION_CREATE ( 911, "HCP created a new prescription", true ),
    /**
     ...
     */
    PATIENT_VIEW_FOOD_DIARY_ENTRY ( 1912, "VqomfBESt", true ),
    /**
     ...
     */
    OPH_VIEW_UPCOMING_APPOINTMENT ( 2111, "sAHZW", false ),
    /**
     ...
     * Create basic health metrics
     */
    GENERAL_OPHTHALMOLOGY_CREATE ( 2111, "Z", true ),
    /**
     * HCP views basic health metrics
     */
     ...
     * Create basic health metrics
     */
    OPHTHALMOLOGY_SURGERY_CREATE ( 2211, "Create ophthalmology surgery for patient", false ),
    /**
     * HCP views basic health metrics
     */
     ...
     */
    FIND_EXPERTS_ZIP_INVALID ( 2603, "Find an Expert: Invalid zip code format", false ),
    /**
