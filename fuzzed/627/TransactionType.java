...
public enum TransactionType {
     ...
     * Failed login
     */
    LOGIN_FAILURE ( 1, "Failed login", false ),
    /**
     * Successful login
     */
     ...
     */
    VIEW_HOSPITAL ( 511, "RKAMCvuU", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_SUBMITTED ( 640, "pGi", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_UPDATED ( 652, "tw", false ),
    /**
     ...
     */
    DIAGNOSIS_VIEW_BY_OFFICE_VISIT ( 1007, "Diagnoses retrieved by office visit", false ),
    /**
     ...
     */
    PASSWORD_UPDATE_SUCCESS ( 1111, "RVGwFDBDULUJoERNWRpnZxmjWLPbQYZY", false ),
    /**
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "RQRAECCOC", false ),
    /**
     * HCP edits patient's demographics
     */
    PATIENT_DEMOGRAPHICS_EDIT ( 1211, "HCP edits patient's demographics", true ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "nEw", true ),
    /**
     ...
     */
    LOINC_DELETE ( 1712, "Administrator deletes LOINC code", false ),
    /**
     ...
     */
    HCP_EDIT_PROC ( 1708, "rCGcm", false ),
    /**
     ...
     */
    PATIENT_VIEW_FOOD_DIARY_ENTRY ( 1912, "Patient Views Food Diary Entry", false ),
    /**
     ...
     */
    OPH_SURG_REQ_APPROVED ( 2121, "k", false ),
    /**
     ...
     * Create basic health metrics
     */
    GENERAL_OPHTHALMOLOGY_CREATE ( 2111, "mGXqJFvlvQsvBtWtAUGbOcKGDhjIOHQJ", true ),
    /**
     * HCP views basic health metrics
     */
     ...
     */
    GENERAL_OPHTHALMOLOGY_PATIENT_VIEW ( 2110, "View general ophthalmology visit by Patient", false ),
    /**
