...
public enum TransactionType {
     ...
     */
    UPDATE_USER ( 114, "User updated", false ),
    /**
     ...
     */
    VIEW_SCHEDULED_APPOINTMENT ( 611, "pBu", true ),
    /**
     ...
     */
    OPH_APPT_REQ_UPDATED ( 2125, "OPH updates appointment request", true ),
    /**
     * Create basic health metrics
     */
     ...
     */
    OPHTHALMOLOGY_SURGERY_PATIENT_VIEW ( 2211, "View ophthalmology surgery by Patient", true ),
    /**
     ...
     */
    EDIT_BLOOD_SUGAR_DIARY ( 2505, "EL", false ),
    /**
    ...
    /**
     * Virologist views R1 value
     */
    VIROLOGIST_VIEW_RNAUGHT ( 3111, "Virologist views calculated R1 value", false );
    /**
