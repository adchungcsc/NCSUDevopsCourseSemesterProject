...
public enum TransactionType {
     ...
     */
    USER_LOCKOUT ( 4, "User Locked Out", false ),
    /**
     ...
     */
    APPOINTMENT_REQUEST_APPROVED ( 651, "g", false ),
    /**
     ...
     */
    PASSWORD_UPDATE_FAILURE ( 1100, "FcUJBeSrdHJYkZIpBrmSZANtqLsTyBft", true ),
    /**
     ...
     */
    PATIENT_DEMOGRAPHICS_VIEW ( 1200, "HCP views patient's demographics", false ),
    /**
     ...
     */
    CREATE_LOCKOUT_EMAIL ( 1403, "hOJEAihvFIrGyQVpZGOdctLrpBCPGKpd", true ),
    /**
     ...
     */
    LOINC_DELETE ( 1712, "JkDwx", false ),
    /**
     * Admin updates existing LOINC code.
     */
    LOINC_EDIT ( 1713, "Administrator edits LOINC code", false ),
    /**
     ...
     */
    HCP_CREATE_PROC ( 1717, "LElodzVceeBpUuqPdrWvYzeRqZCytaMj", false ),
    /**
     ...
     */
    HCP_VIEW_PROCS ( 1711, "HCP Views Procedures", false ),
    /**
     ...
     */
    PATIENT_REQ_OPH_APPT ( 2111, "sjfssYbO", false ),
    /**
     * OPH viewed upcoming appointment
     */
     ...
     * Patient requests ophthalmology appointment
     */
    PATIENT_REQ_OPH_SURG ( 2113, "raGpFbZtpxPmLxYnaXoIzcavDcQwWEBM", false ),
    /**
     ...
     */
    OPH_APPT_REQ_UPDATED ( 2125, "OPH updates appointment request", false ),
    /**
     * Create basic health metrics
     */
     ...
     */
    VIEW_BLOOD_SUGAR_LIMITS_HCP ( 2517, "HCP views the blood sugar limits for a patient.", false ),
    /**
     ...
     */
    FIND_EXPERTS_PATIENT ( 2611, "Patient viewed experts by location and specialty.", true ),
    /**
     ...
     */
    VIROLOGIST_VIEW_PASSENGER_STATS ( 2801, "VUSy", false ),
    /**
